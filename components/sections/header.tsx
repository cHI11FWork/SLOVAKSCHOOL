...
export function Header({ content, lang }: { content: HeaderContent; lang: Lang }) {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-[1200px] items-center justify-between gap-4 px-5 py-4 min-[900px]:gap-6 min-[900px]:px-8 min-[900px]:py-6">
        ...
        <div className="flex flex-1 items-center justify-end gap-3 min-[900px]:flex-none min-[900px]:gap-4">
          <LangSwitcher current={lang} className="hidden min-[900px]:flex" />
          <a
            href="#contact"
          ...
          <a
            href="#contact"
            className="inline-flex flex-1 items-center justify-center rounded-full bg-[#1e2156] px-5 py-3 text-center text-base font-medium text-white shadow-[0_8px_20px_-10px_rgba(30,33,86,0.6)] transition-transform active:scale-95 min-[900px]:hidden"
          >
            {content.cta}
          </a>
          <button
            ...
            className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-[#e6e6e6] text-[#1e2156] transition-colors hover:bg-[#fafafb] min-[900px]:hidden"
          >
        ...
        {menuOpen && (
          ...
          >
            <div className="flex flex-col gap-1 px-5 py-4">
              ...
              <div className="mt-2 flex items-center justify-between border-t border-[#e6e6e6] px-3 pt-4">
                <span className="text-sm text-[#979799]">Мова сайту</span>
